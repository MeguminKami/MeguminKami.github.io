...
export const GRID_SLOT_MINUTES = SLOT_MINUTES;
export const VISIBLE_MINUTES = END_MINUTE - START_MINUTE;
export const HOUR_COUNT = VISIBLE_MINUTES / HOUR_MINUTES;
export const SLOT_COUNT = VISIBLE_MINUTES / GRID_SLOT_MINUTES;
